	...
	return (
		<div className="flex-1 bg-slate-200 dark:bg-slate-800 shadow-md rounded-2xl p-6">
			...
			<div className="space-y-4 mb-6">
				<div className="animate-pulse bg-slate-300 dark:bg-slate-700 h-16 rounded-lg shadow-sm" />
				<div className="animate-pulse bg-slate-300 dark:bg-slate-700 h-16 rounded-lg shadow-sm" />
				<div className="animate-pulse bg-slate-300 dark:bg-slate-700 h-16 rounded-lg shadow-sm" />
			</div>

			<div className="animate-pulse bg-slate-300 dark:bg-slate-700 h-10 rounded-lg" />
		</div>
	);
};
